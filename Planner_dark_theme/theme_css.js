$("body").append(`<style id='my-custom-dark-style'>
            ...
            .topHeader .topHeaderLandmark>.nonIcon>div .primarySection>.primaryTextSectionContainer>div.primaryTextSection>button.primaryTextSectionTitle            
            {
                color: white;
            }
